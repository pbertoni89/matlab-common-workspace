function [ Y ] = LP_Double_Matrix( X, gain, verbose )
%LP_FILTER  Low - pass filter for double matrices.
%   [ Y ] = LP_Double_Matrix( X, gain, verbose )
...
if verbose == 1
        for r = 1 : dim(1)
            ...
            temp1(r,:) = conv( double(img_padded), double(h_padded) );
