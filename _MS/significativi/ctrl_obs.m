...
if det(R)==0
	...
	% nella realtà difficilmente è noto lo stato di un sistema.
	% Occorre stimarlo dall'uscita, noto il vettore C!
    % det(lambda*I-(A+L*C))=0 -> l1o l2o
    % osservatore più veloce del sistema, per stargli dietro..
	% chiaramente la retroazione si basa sullo stato OSSERVATO==STIMATO
