%         CARTINA GEOGRFICA
%Di una fotografia scattata da un elicottero è nota la relazione
...
%seguito è analogo agli esercizi precedenti ( vedi Pressione Arteriosa).
...
M=[x1 x2];  %nn c'è il vettore di 1 perchè nn c'è il termine noto
